...
const { connect } = require('../routes/restaurants');
...
exports.put_update_restaurant = async (request, response) => {
    try {
        ...
        db.collection('restaurants').
            updateOne({ email: request.body.email }, { $set: { name: request.body.name, address: request.body.address, postalcode: request.body.postalcode, phonenumber: request.body.phonenumber } });
        return response.status(200).json({
